  ...
  render: ({ trace, element }) => {
    ...
    formContainer.innerHTML = `
          <style>
            ...
            textarea {
              background: white;
              height: 100px; /* Adjust this value to increase/decrease the height */
            }
            .phone {
              width: 150px;
            }
            ...
            .date-title {
              ...
              margin: 10px 0;
              // color: #888; /* Optional: change the color if needed */
            }
            .phone-description {
              font-size: 0.7em; /* Adjust this value to change the font size */
              font-style: italic;
              color: #888; /* Optional: change the color if needed */
              margin: 5px 0 15px 0;
            }
          ...
          <label for="location">Surfbreak Location</label>
          <select class="location" name="location" required>
            <option value="" disabled selected></option>
            <option value="Surfbreak HNL 🇺🇸">Surfbreak HNL, Hawaii 🇺🇸</option>
            <option value="Surfbreak PXM 🇲🇽">Surfbreak PXM, Mexico 🇲🇽</option>
            <option value="I am interested in both">I am interested in both</option>
          </select><br><br>
          ...
          <div class="phone-description">Please specify the country code (e.g., +31 for Netherlands 🇳🇱)</div><br>

          <div class="date-title">Please give an indication of what dates you will be visiting Surfbreak:</div>
          <label for="start-date">Arrival Date</label>
          <input type="date" class="start-date" name="start-date" required><br><br>

          <label for="end-date">Departure Date</label>
          <input type="date" class="end-date" name="end-date" required><br><br>
    ...
    formContainer.addEventListener('submit', function (event) {
      ...
      const location = formContainer.querySelector('.location')
      const name = formContainer.querySelector('.name')
      const email = formContainer.querySelector('.email')
      const phone = formContainer.querySelector('.phone')
      const startDate = formContainer.querySelector('.start-date')
      const endDate = formContainer.querySelector('.end-date')
